!define PRODUCT_NAME "Serial2String"
!define PRODUCT_VERSION "1.0"
!define PY_VERSION "3.7.4"
!define PY_MAJOR_VERSION "3.7"
!define BITNESS "64"
!define ARCH_TAG ".amd64"
!define INSTALLER_NAME "Serial2String_1.0.exe"
...
!define MULTIUSER_INSTALLMODE_INSTDIR "Serial2String"
...
Section "!${PRODUCT_NAME}" sec_app
  ...
  SetOutPath "%HOMEDRIVE%\%HOMEPATH%"
    CreateShortCut "$SMPROGRAMS\Serial2String.lnk" "$INSTDIR\Python\python.exe" \
      '"$INSTDIR\Serial2String.launch.py"' "$INSTDIR\icon.ico"
  SetOutPath "$INSTDIR"
...
Section "Uninstall"
  ...
  ; Uninstall files
    Delete "$INSTDIR\Serial2String.launch.py"
  ...
  ; Uninstall shortcuts
      Delete "$SMPROGRAMS\Serial2String.lnk"
  RMDir $INSTDIR
